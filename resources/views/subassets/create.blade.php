            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form method="post" action="{{ route('dashboard.subassets.store') }}">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input autofocus type="text" class="form-control" id="survey_no" name="survey_no" placeholder="Survey No" value="" required maxlength="255">
                                    </div>
                                </div>
                                
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="parcel_no">Title No</span></label>
                                        <input autofocus type="text" class="form-control" id="parcel_no" name="parcel_no" placeholder="Title No" value="" maxlength="255">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input autofocus type="number" class="form-control" id="acres" name="acres" placeholder="Total Acres" value="" step="any" required maxlength="255">
                                    </div>
                                </div>
