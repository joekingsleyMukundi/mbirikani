                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ route('dashboard.allocations.import.download.sample') }}" class="btn btn-primary mt-2">Download Sample</a>

                            <form method="post" action="{{ route('dashboard.allocations.import.store') }}" enctype="multipart/form-data">
                                @csrf
