            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                            ...
                            <form method="post" enctype="multipart/form-data" action="{{ route('dashboard.users.store') }}">
                                @csrf
                                <div class="card-body">
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input autofocus type="number" class="form-control" id="phone" name="phone" placeholder="Phone" value="" required maxlength="255">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input autofocus type="email" class="form-control" id="email" name="email" placeholder="Email" value="" required maxlength="255">
