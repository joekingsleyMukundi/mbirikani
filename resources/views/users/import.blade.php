                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            You can import users only based on role. <br>
                            To add roles go to settings and click Roles. <a href="{{ route('dashboard.settings.roles.index') }}">Take Me To Roles</a> <br>

                            <a href="{{ route('dashboard.users.import.download.sample') }}" class="btn btn-primary mt-2">Download Sample</a>

                            <form method="post" action="{{ route('dashboard.users.import.store') }}" enctype="multipart/form-data">
                                @csrf
