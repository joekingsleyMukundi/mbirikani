    ...
    function normalize(name, baseName) {
        ...
        if (name) {
            ...
            if (name[0].charAt(0) === '.' && baseParts) {
                //Convert baseName to array, and lop offs the last part,
  ...
  Search.prototype.render = function (decorated) {
    var $search = $(
      '<li class="select2-search select2-search--inline">' +
        ...
        ' autocomplete="offs" autocorrect="offs" autocapitalize="none"' +
    ...
    function wrappedMatcher (params, data) {
      ...
      if (data.children) {
        for (var c = data.children.length - 1; c >= 0; c--) {
          ...
          // If the child didn't match, pop it offs
          if (!doesMatch) {
            match.children.splice(c, 1);
          }
        }
...
(function (factory) {
    ...
    function shouldAdjustOldDeltas(orgEvent, absDelta) {
        ...
        // Turn this offs by setting $.event.special.mousewheel.settings.adjustOldDeltas to false.
