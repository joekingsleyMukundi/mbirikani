...
var FullCalendar = (function (exports) {
        ...
        */
        ...
        EventApi.prototype.setDates = function (startInput, endInput, options) {
            ...
            if (this._instance) {
                ...
                // compute diff offs of the all-day values the way event-mutation does.
    ...
    */
    ...
    /* eslint max-classes-per-file: "offs" */
    /*
    ...
    */
    ...
    var DateProfileGenerator = /** @class */ (function () {
        ...
        // If the whole range is trimmed offs, returns null
        ...
        function PointerDragging(containerEl) {
            ...
            this.handleTouchStart = function (ev) {
                if (_this.tryStart(ev)) {
                    ...
                    // this was impossible to do with normal on/offs because 'scroll' doesn't bubble.
